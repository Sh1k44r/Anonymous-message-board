...
module.exports = function (app) {
  ...
  /* 
      VS code has a mongodb extension which allow me to circumvent this method here |
                                                                                    V
	let uri = 'mongodb+srv://Shikaar:' + process.env.PW + '@freecodecamp.b0myq.mongodb.net/anonymous_message_board?retryWrites=true&w=majority'
